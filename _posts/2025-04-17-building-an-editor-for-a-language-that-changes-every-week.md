...
There's something I call `ES|QL`'s *language image* (or just "image").<sup>2</sup> The image consists of the basic boundaries of what is and is not allowed in a query. It also records what is going to happen when a query is sent to the server. This encompasses 
...
[2] I kind of stole this from Don Norman's *system image* but I'm using it with a different meaning.
